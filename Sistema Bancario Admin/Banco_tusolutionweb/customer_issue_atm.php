...
<div class='content_customer'>
    ...
    <table align="center">
        <tr><td>Problema: <select name="atm">
        <option value='ATM' selected>ATM</option>
        <option value='CHEQUE'>Talonario de cheques</option></td><tr>
    ...
    <?php 
        ...
        echo "<th>Peticiones</th><th>Status</th>";
        echo "<tr><td>Estado de la tarjeta ATM: </td><td>$atm_status</td></tr>";
        echo "<tr><td>Verificar el estado del libro: </td><td>$c_status</td></tr>";
            echo "</table>"; }?>
